...
// Final destination for every contact-form submission. Note: Resend's
// sandbox sender (no verified domain yet) can only deliver to the email that
// owns the Resend account, so sending to this address will 403 until a
// sending domain is verified in Resend and EMAIL_FROM is set accordingly.
